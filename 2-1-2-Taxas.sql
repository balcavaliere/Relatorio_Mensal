...
FROM 
		...
		FROM Receitas
		WHERE (DataMovimento BETWEEN '2021-01-01' AND '2021-08-31' AND CodigoOrcamentario IN ('1122011110','1121041100','1121260000','1121011107','1121011106','1121011118','1121011108', '1121011102', '1121011101', '1121011103', '1121011109' , '1122011101'))
		GROUP BY Nivel4) a21
	FULL OUTER JOIN
		(SELECT Nivel4, SUM (ValorRealizado + ValorDeducao + ValorEstorno) AS "2020"
		FROM Receitas
		WHERE (DataMovimento BETWEEN '2020-01-01' AND '2020-08-31' AND CodigoOrcamentario IN ('1122011110','1121041100','1121260000','1121011107','1121011106','1121011118','1121011108', '1121011102', '1121011101', '1121011103', '1121011109' , '1122011101'))
		GROUP BY Nivel4) a20
...
GROUP BY co.Descricao, a21.[2021],a20.[2020],co.CodigoOrcamentario
/* TABELA FIM */
